    ...
    <Section className="pb-16 sm:pb-24">
      <Container>
        <Reveal direction="zoom">
          <div className="relative overflow-hidden rounded-3xl bg-[#0b0f17] text-white">
            <div className="absolute inset-0">
              <Image
                src={media.hero.circuit}
                alt=""
                fill
                className="object-cover opacity-25 transition-opacity duration-700 hover:opacity-40"
                sizes="100vw"
              />
              <div className="absolute inset-0 bg-gradient-to-br from-[#0b0f17] via-[#0b0f17]/92 to-primary/25" />
            ...
            <div className="relative flex flex-col items-center gap-6 p-10 text-center sm:p-16">
              ...
              <h2 className="max-w-2xl font-display text-3xl font-semibold tracking-tight sm:text-4xl lg:text-5xl">
                ...
                <span className="text-gradient-cyan">Let&apos;s build it together.</span>
              </h2>
