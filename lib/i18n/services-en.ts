...
export const enUseCases: UseCaseContent[] = [
  { label: "Restaurants", sub: "Tap-to-menu experiences" },
  { label: "Hotels", sub: "Keyless guest experiences" },
  { label: "Companies", sub: "Smart business cards" },
...
export const enServices: Record<string, ServiceContent> = {
  "nfc-business-cards": {
    ...
    process: [
      { step: "01", title: "Consult", description: "We understand how you network and what your profile needs to achieve." },
      { step: "02", title: "Design", description: "We design the card and the digital profile it opens on a tap." },
      { step: "03", title: "Encode & print", description: "We encode, test and print so every card works straight out of the box." },
      { step: "04", title: "Deliver", description: "You receive ready-to-use cards with analytics and future updates." },
    ],
  ...
  "nfc-digital-profiles": {
    ...
    process: [
      { step: "01", title: "Define", description: "We define what the profile should show and how it's used." },
      { step: "02", title: "Design", description: "We design a polished profile page around your brand." },
      { step: "03", title: "Connect", description: "We encode the profile to your NFC products and add analytics." },
      { step: "04", title: "Evolve", description: "You update content anytime and we keep it fresh." },
    ],
  ...
  "nfc-smart-menus": {
    ...
    process: [
      { step: "01", title: "Audit", description: "We review your menu, branding and guest experience." },
      { step: "02", title: "Build", description: "We build a fast, beautiful digital menu." },
      { step: "03", title: "Deploy", description: "We fit NFC tags at every table and test each one." },
      { step: "04", title: "Update", description: "Prices and dishes change in minutes — no reprints." },
    ],
  ...
  "nfc-google-reviews": {
    ...
    process: [
      { step: "01", title: "Setup", description: "We configure the exact link to your review page." },
      { step: "02", title: "Design", description: "We design cards or tags that invite a review naturally." },
      { step: "03", title: "Deploy", description: "We place and test the tags in high-traffic spots." },
      { step: "04", title: "Grow", description: "We review performance and help reviews keep flowing." },
    ],
  ...
  "nfc-marketing-products": {
    ...
    process: [
      { step: "01", title: "Plan", description: "We define the campaign and the tap experience." },
      { step: "02", title: "Create", description: "We design materials and the digital experience." },
      { step: "03", title: "Produce", description: "We embed, encode and test every NFC element." },
      { step: "04", title: "Measure", description: "We track engagement and optimize the campaign." },
    ],
  ...
  "nfc-smart-tags": {
    ...
    process: [
      { step: "01", title: "Identify", description: "We find the right surfaces and use cases." },
      { step: "02", title: "Select", description: "We pick the right tag type for the surface." },
      { step: "03", title: "Encode", description: "We encode and test each tag." },
      { step: "04", title: "Deploy", description: "We deliver and help you roll out." },
    ],
  ...
  "custom-nfc-solutions": {
    ...
    process: [
      { step: "01", title: "Ideate", description: "We define the product, use case and experience." },
      { step: "02", title: "Prototype", description: "We prototype the item and test it on real phones." },
      { step: "03", title: "Produce", description: "We encode and produce units at any volume." },
      { step: "04", title: "Launch", description: "We deliver ready-to-use products with documentation." },
    ],
  ...
  "nfc-event-solutions": {
    ...
    process: [
      { step: "01", title: "Plan", description: "We map your event flow and check-in experience." },
      { step: "02", title: "Design", description: "We design badges and passes around your branding." },
      { step: "03", title: "Deploy", description: "We encode, test and set up gates before the event." },
      { step: "04", title: "Run", description: "Guests tap in and you see live attendance." },
    ],
  ...
  "nfc-hotel-solutions": {
    ...
    process: [
      { step: "01", title: "Assess", description: "We review your hotel's guest journey and operations." },
      { step: "02", title: "Design", description: "We design key cards and in-room touchpoints." },
      { step: "03", title: "Encode", description: "We program and test every key and touchpoint." },
      { step: "04", title: "Launch", description: "We roll out across rooms with staff training." },
    ],
  ...
  "nfc-retail-solutions": {
    ...
    process: [
      { step: "01", title: "Audit", description: "We review your store and product range." },
      { step: "02", title: "Build", description: "We build digital product pages and encode tags." },
      { step: "03", title: "Deploy", description: "We place and test tags across the store." },
      { step: "04", title: "Grow", description: "We track engagement and optimize placement." },
    ],
  ...
  "nfc-healthcare-solutions": {
    ...
    process: [
      { step: "01", title: "Consult", description: "We understand your facility and patient flow." },
      { step: "02", title: "Design", description: "We design cards and touchpoints for your setting." },
      { step: "03", title: "Configure", description: "We set up secure check-in and access flows." },
      { step: "04", title: "Support", description: "We train staff and support rollout." },
    ],
  ...
  "nfc-education-solutions": {
    ...
    process: [
      { step: "01", title: "Discover", description: "We review campus systems and student flows." },
      { step: "02", title: "Design", description: "We design cards and the experiences they unlock." },
      { step: "03", title: "Integrate", description: "We connect attendance, access and payments." },
      { step: "04", title: "Launch", description: "We roll out cards with training and support." },
    ],
  ...
  "ai-chatbots": {
    ...
    process: [
      { step: "01", title: "Map", description: "We map the questions customers ask and actions to automate." },
      { step: "02", title: "Train", description: "We build and train the assistant on your knowledge base." },
      { step: "03", title: "Deploy", description: "We integrate it into your website or WhatsApp." },
      { step: "04", title: "Improve", description: "We monitor conversations and improve answers continuously." },
    ],
  ...
  "customer-support-automation": {
    ...
    process: [
      { step: "01", title: "Audit", description: "We review your support channels and common issues." },
      { step: "02", title: "Automate", description: "We build automated resolution flows." },
      { step: "03", title: "Integrate", description: "We connect to your existing support tools." },
      { step: "04", title: "Refine", description: "We monitor results and improve automation." },
    ],
  ...
  "ai-assistants": {
    ...
    process: [
      { step: "01", title: "Define", description: "We identify the tasks the assistant should own." },
      { step: "02", title: "Train", description: "We build and train on your business data." },
      { step: "03", title: "Deploy", description: "We roll it out to your team." },
      { step: "04", title: "Optimize", description: "We refine performance over time." },
    ],
  ...
  "business-ai-tools": {
    ...
    process: [
      { step: "01", title: "Discover", description: "We find where AI adds the most value." },
      { step: "02", title: "Build", description: "We develop a custom AI tool for the job." },
      { step: "03", title: "Integrate", description: "We connect it to your workflow." },
      { step: "04", title: "Scale", description: "We expand AI to more processes." },
    ],
  ...
  "ai-integration": {
    ...
    process: [
      { step: "01", title: "Assess", description: "We evaluate your systems and AI opportunities." },
      { step: "02", title: "Design", description: "We design the AI integration." },
      { step: "03", title: "Build", description: "We implement and test securely." },
      { step: "04", title: "Launch", description: "We deploy and support the integration." },
    ],
  ...
  "website-development": {
    ...
    process: [
      { step: "01", title: "Discover", description: "We learn your business, audience and goals first." },
      { step: "02", title: "Design", description: "We prototype a modern interface you can preview." },
      { step: "03", title: "Build", description: "We develop with clean code and mobile-first design." },
      { step: "04", title: "Launch", description: "We test, deploy and optimize with support." },
    ],
  ...
  "mobile-applications": {
    ...
    process: [
      { step: "01", title: "Ideate", description: "We refine your idea into a clear feature set." },
      { step: "02", title: "Prototype", description: "We design interactive screens before development." },
      { step: "03", title: "Develop", description: "We build the app in sprints with regular demos." },
      { step: "04", title: "Publish", description: "We prepare store assets and ship your app." },
    ],
  ...
  "custom-software": {
    ...
    process: [
      { step: "01", title: "Analyze", description: "We audit workflows to find where software saves time." },
      { step: "02", title: "Design", description: "We architect a solution that fits your team." },
      { step: "03", title: "Build", description: "We develop in iterative cycles with feedback." },
      { step: "04", title: "Adopt", description: "We deploy, train and support the system long-term." },
    ],
  ...
  "business-automation": {
    ...
    process: [
      { step: "01", title: "Audit", description: "We find the repetitive tasks costing you time." },
      { step: "02", title: "Plan", description: "We design an automation roadmap with clear wins." },
      { step: "03", title: "Automate", description: "We build workflows that run on their own." },
      { step: "04", title: "Optimize", description: "We monitor and improve automation over time." },
    ],
  ...
  dashboards: {
    ...
    process: [
      { step: "01", title: "Map", description: "We identify the metrics that drive your decisions." },
      { step: "02", title: "Connect", description: "We connect your data sources and clean the data." },
      { step: "03", title: "Build", description: "We build the dashboard around your KPIs." },
      { step: "04", title: "Refine", description: "We tune views and reporting as you grow." },
    ],
  ...
  "admin-panels": {
    ...
    process: [
      { step: "01", title: "Discover", description: "We map the operations your team manages." },
      { step: "02", title: "Design", description: "We design an admin experience your team will use." },
      { step: "03", title: "Build", description: "We build the panel and its APIs." },
      { step: "04", title: "Empower", description: "We train your team and roll it out." },
    ],
  ...
  "crm-systems": {
    ...
    process: [
      { step: "01", title: "Understand", description: "We study your sales process and touchpoints." },
      { step: "02", title: "Design", description: "We design pipelines and workflows that fit." },
      { step: "03", title: "Build", description: "We build and integrate your CRM." },
      { step: "04", title: "Adopt", description: "We migrate data and train your team." },
    ],
